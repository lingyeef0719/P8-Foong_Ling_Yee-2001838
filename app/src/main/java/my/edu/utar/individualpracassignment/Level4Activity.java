...
public class Level4Activity extends AppCompatActivity {
    ...
    private int score = 0, level = 1, numOfViews = 25;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < numOfViews; i++){
            textViewList.get(i).setHeight(width / 5);
        }
        ...
        countDownTimer = new CountDownTimer( 5000, 1000) {
            ...
            public void onFinish() {
                ...
                exitButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Level4Activity.this, ScoreboardActivity.class);
                        intent.putExtra("score", score);
                        startActivity(intent);
                        finish();
                    }
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v == highlightedView) {
                        ...
                        Toast.makeText(Level4Activity.this, "Wrong choice!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
